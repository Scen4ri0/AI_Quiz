...
_ZOOMER_TERMS: list[str] = [
    "Кринж", "Мид", "Топ", "Скам", "Сигма",
    "Норм",  "Фейл", "Лол",  "База", "Факт", 
    "Душно", "Тильт", "Вайб", "Чил", 
    "NPC", "Бот", "Фейк","Рэд флаг", "Грин флаг",
    "Скуф",
    "Хайп",
    "Краш", 
    "Луз", "Вин", "Тащить", "Скилл", "Нуб",
    "Это база", "Плюс реп",
...
def _make_grade_prompt(question: str, user_answer: str, pool: list[str], strict: bool) -> str:
    ...
    if strict:
        extra = """
СТРОГО:
- если не вставишь 1-3 терминов из пула внутри обычных предложений — переформулируй
...
1) Если ok=false:
   ...
   Не пербарщивай со сленгом, найди баланс между конструктивной информацией и друским сленгом
2) Если ok=true:
   - 4–8 предложений
   - объясни суть корректно
   - используй 1-3 терминов из пула уместно
   - Не пербарщивай со сленгом, найди баланс между конструктивной информацией и друским сленгом
   - 1–3 эмодзи
...
- 1-3 терминов из пула внутри обычных предложений
-Не пербарщивай со сленгом, найди баланс между конструктивной информацией и друским сленгом
